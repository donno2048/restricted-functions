...
Better docs can be found under [the _docs/ref_ folder](https://github.com/donno2048/restricted-functions/tree/master/docs/ref){:target="_blank" rel="noopener"}, but you can use:
